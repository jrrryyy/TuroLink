  ...
  return <DashboardLayout role="teacher" requestCount={requests.length} searchPlaceholder="Search your subjects...">
    <div className="teacher-overview">
      ...
      {!data && !error ? <div className="teacher-overview-loading" role="status">Loading your teaching overview...</div> : data && <>
        ...
        <div className="teacher-overview-grid"><section className="teacher-ui-card"><header><div><span className="teacher-eyebrow">PLAN YOUR DAY</span><h2>Upcoming sessions</h2></div><Link to="/teacher/schedules">View all<ArrowRight size={16} /></Link></header>
